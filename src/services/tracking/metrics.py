...
import time
from src.services.config.workout_config import METRICS_FIELDS
from src.services.persistence.exercise_repository import add_exercise
...
def sync_metrics_update(context):
    ...
    if workout_completed and not st.session_state.get(
